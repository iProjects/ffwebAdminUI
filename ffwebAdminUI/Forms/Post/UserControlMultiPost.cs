...
namespace ffwebAdminUI
{
    public partial class UserControlMultiPost : UserControl
    {
        ...
        public UserControlMultiPost(TransactionType ttype)
        {
            InitializeComponent();
        ...
        private void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (IsTransactionValid())
                {
                    ...
                    transactions = fc.CreateTransactionsFromTransactionType(TType.TransactionTypeID, debitaccountid, creditaccountid, Amount, "Multi Post", contraref, "sys", "system");
