...
namespace ffwebAdminUI
{
    public partial class UserControlSinglePost : UserControl
    {
        ...
        public UserControlSinglePost(TransactionType ttype)
        {
            InitializeComponent();
        ...
        private void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (IsTransactionValid())
                {
                    ...
                    transactions = fc.CreateTransactionsFromTransactionType(TType.TransactionTypeID, debitaccountid, creditaccountid, Amount, "single Post", contraref, "sys", "system");
